...
### Added
- `data-markdown-main` attribute to scope Markdown conversion to a specific element, ignoring the rest of the page (header, footer, etc.). Can be used alone, combined with `data-markdown-ignore`, or omitted to keep the default `<body>` behaviour
...
[Unreleased]: https://github.com/paultursuru/mark-don/compare/v0.1.3...HEAD
[0.1.3]: https://github.com/paultursuru/mark-don/compare/v0.1.2...v0.1.3
